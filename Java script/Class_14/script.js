...
//         printApiData(Object1.response)
//     })
// }

// callbackHall("GET","https://jsonplaceholder.typicode.com/posts",(data) =>{
//     console.log(data);
// })
...
/*Promish : Promish is object in java script : which gives assurance / gurrantee i will give u somthing 
        1.Pading (default) const p = new promishm(Resolve Reject)
          a.than :  (resolve ka result dekhne ke liye than ka use kiya jata hai)
                    than method 1 call back fuction leta he 
          
          b.catch : (reject ka result dekhne ke liye than ka use kiya jata hai)
                  catch method 1 call back fuction leta  
...
// function  FeatchProduct(urrl){
//         const  res = fetch(url);
//       return res;
// }


// const  p = FeatchProduct("https://fakestoreapi.com/products");
// // console.log(p)

// than.p((dsat)=>{
//         DataTransfer.json().then(())
// })
